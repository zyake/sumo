...
import zyake.libs.sql.ParamBuilder;
 ...
 *     the result {@link zyake.libs.sql.QueryExpression} object can resolve a parameter position by name
 *     when the {@link zyake.libs.sql.QueryExpression#evaluate(java.sql.PreparedStatement, zyake.libs.sql.ParamBuilder)}
 *     method was invoked.
 * </p>
 */
